...
function HomePage({ data, nav, settings }) {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement("section", { className: "container", style: { padding: "72px 20px" } },
            ...
            React.createElement("div", { className: "fragrance-grid", style: { marginTop: 36 } }, data.fragrances.filter((f) => f.active).map((f) => React.createElement(FragranceCard, { key: f.slug, fragrance: f, images: data.images, nav: nav })))),
        ...
        React.createElement("section", { className: "container", style: { padding: "72px 20px" } },
            ...
            React.createElement("div", { className: "product-grid", style: { marginTop: 36 } }, bestsellers.map((p) => React.createElement(ProductCard, { key: p.slug, product: p, fragrance: fragranceById[p.fragranceSlug], images: data.images, nav: nav })))),
