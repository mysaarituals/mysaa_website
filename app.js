...
function Header({ nav, settings }) {
    ...
    return (React.createElement("header", { style: { position: "sticky", top: 0, zIndex: 40, background: "rgba(252,250,247,0.95)", borderBottom: `1px solid ${C.line}`, backdropFilter: "blur(6px)" } },
        ...
        open && (React.createElement("div", { className: "mobile-only", style: { padding: "0 20px 20px", display: "flex", flexDirection: "column", gap: 2, background: C.cream, borderTop: `1px solid ${C.line}` } },
            [["Home", "home", null], ["Catalogue", "catalogue", "all"], ["About", "about", null], ["Contact", "contact", null]].map(([lbl, page, param]) => (React.createElement("button", { key: lbl, onClick: () => { nav(page, param); setOpen(false); }, style: { ...sans, textAlign: "left", padding: "12px 4px", fontSize: 15, color: C.ink, borderBottom: `1px solid ${C.line}` } }, lbl))),
    ...
    return (React.createElement("div", null,
        React.createElement("section", { style: { borderBottom: `1px solid ${C.line}` } },
            React.createElement("div", { className: "container hero-grid", style: { padding: "72px 20px 64px" } },
                React.createElement("div", { style: { maxWidth: 540 } },
                    ...
                    React.createElement("h1", { style: { ...serif, fontSize: "clamp(34px,6vw,54px)", color: C.ink, fontWeight: 500, lineHeight: 1.1, marginBottom: 20 } }, "Fragrance, made personal."),
                    React.createElement("p", { style: { ...sans, fontSize: 16, color: C.ink70, lineHeight: 1.75, marginBottom: 30, maxWidth: 460 } }, "Handcrafted candles and gifts inspired by Indian fragrances, memories and everyday rituals."),
                    React.createElement("div", { style: { display: "flex", gap: 20, alignItems: "center", flexWrap: "wrap", marginBottom: 18 } },
                    ...
                    React.createElement("a", { href: waLink(settings.whatsapp, "Hello Mysaa Rituals!"), target: "_blank", rel: "noreferrer", style: { ...label, color: C.ink70, textDecoration: "underline", textUnderlineOffset: "3px" } }, "Chat on WhatsApp")),
                React.createElement(Placeholder, { label: "Hero product photograph", ratio: "4 / 3" }))),
        React.createElement("section", { className: "container", style: { padding: "72px 20px" } },
            React.createElement(SectionHeading, { eyebrow: "The Fragrances", title: "Every fragrance holds a feeling.", sub: "From the warmth of sandalwood to the romance of jasmine and the mystery of night-blooming florals, each Mysaa ritual is created to evoke something personal." }),
            React.createElement("div", { className: "fragrance-grid", style: { marginTop: 36 } }, data.fragrances.filter((f) => f.active).map((f) => React.createElement(FragranceCard, { key: f.slug, fragrance: f, nav: nav })))),
            ...
            React.createElement("div", { className: "container", style: { padding: "72px 20px" } },
                ...
                React.createElement("div", { className: "two-ways-grid", style: { marginTop: 40 } },
                    ...
                    React.createElement("button", { onClick: () => nav("catalogue", "candle"), style: { background: "#fff", border: `1px solid ${C.line}`, padding: "36px 28px", textAlign: "left" } },
                        ...
                        React.createElement("span", { style: { ...label, color: C.rust } }, "Explore \u2192"))))),
        React.createElement("section", { className: "container", style: { padding: "72px 20px" } },
            React.createElement(SectionHeading, { eyebrow: "Curated", title: "Made to be lit slowly." }),
            React.createElement("div", { className: "product-grid", style: { marginTop: 36 } }, bestsellers.map((p) => React.createElement(ProductCard, { key: p.slug, product: p, fragrance: fragranceById[p.fragranceSlug], nav: nav })))),
        React.createElement("section", { className: "container", style: { padding: "20px 20px 72px" } },
            React.createElement("div", { className: "personalize-grid" },
                ...
                React.createElement("div", null,
                    ...
                    React.createElement("h2", { style: { ...serif, fontSize: "clamp(24px,3.6vw,32px)", color: C.ink, fontWeight: 500, marginBottom: 16 } }, "Made for your moment."),
                    React.createElement("p", { style: { ...sans, fontSize: 15, color: C.ink70, lineHeight: 1.75, marginBottom: 24, maxWidth: 420 } }, "Have something specific in mind? Choose your fragrance, jar size, label or packaging and let us create something personal for you."),
        ...
        React.createElement("section", { style: { background: C.card, borderTop: `1px solid ${C.line}`, borderBottom: `1px solid ${C.line}` } },
            React.createElement("div", { className: "container gifting-grid", style: { padding: "72px 20px" } },
                React.createElement("div", null,
                    ...
                    React.createElement("h2", { style: { ...serif, fontSize: "clamp(24px,3.6vw,32px)", color: C.ink, fontWeight: 500, marginBottom: 22 } }, "Gifts that feel personal."),
                    React.createElement("div", { className: "gifting-list" },
                        ...
                        React.createElement("span", { style: { ...sans, fontSize: 14, color: C.ink70 } }, "Rakhi"),
                ...
                React.createElement(Placeholder, { label: "Gift hamper flat-lay", ratio: "4 / 3" }))),
        React.createElement("section", { className: "container", style: { padding: "72px 20px" } },
            React.createElement(HowToOrder, { steps: HOW_TO_ORDER_HOME })),
        React.createElement("section", { style: { background: C.ink, color: "#fff" } },
            React.createElement("div", { className: "container", style: { padding: "64px 20px", textAlign: "center" } },
                React.createElement("h2", { style: { ...serif, fontSize: "clamp(22px,3.4vw,28px)", fontWeight: 500, marginBottom: 12 } }, "Have something special in mind?"),
                React.createElement("p", { style: { ...sans, fontSize: 14, color: "#D8CFC3", maxWidth: 420, margin: "0 auto 24px", lineHeight: 1.7 } }, "Tell us what you're looking for and we'll help you create the right ritual."),
...
function CataloguePage({ data, nav, initialType, initialQuery }) {
    ...
    return (React.createElement("div", { className: "container", style: { padding: "48px 20px 80px" } },
        ...
        React.createElement("div", { style: { marginTop: 32, display: "flex", flexDirection: "column", gap: 20 } },
            ...
            (category !== "all" || fragrance !== "all" || search) && (React.createElement("button", { onClick: resetFilters, style: { ...label, color: C.rust, textAlign: "left", textDecoration: "underline", textUnderlineOffset: "3px" } }, "Clear filters"))),
        React.createElement("p", { style: { ...sans, fontSize: 13, color: C.ink70, marginTop: 28 } },
            filtered.length,
            " product",
            filtered.length !== 1 ? "s" : "",
            " found"),
        React.createElement("div", { className: "product-grid", style: { marginTop: 20 } }, filtered.map((p) => React.createElement(ProductCard, { key: p.slug, product: p, fragrance: fragranceById[p.fragranceSlug], nav: nav }))),
        filtered.length === 0 && (React.createElement("div", { style: { padding: "60px 0", textAlign: "center" } },
            React.createElement("p", { style: { ...sans, color: C.ink70, marginBottom: 20 } }, "No products match those filters yet."),
...
function ProductDetailPage({ data, nav, slug, settings }) {
    ...
    return (React.createElement("div", { className: "container", style: { padding: "32px 20px 80px" } },
            ...
            React.createElement("div", null,
                ...
                React.createElement("div", { style: { marginBottom: 28 } },
                    ...
                    React.createElement("div", { style: { display: "inline-flex", alignItems: "center", border: `1px solid ${C.line}` } },
                        React.createElement("button", { onClick: () => setQty((q) => Math.max(1, q - 1)), style: { ...sans, fontSize: 16, padding: "10px 16px", color: C.ink }, "aria-label": "Decrease quantity" }, "\u2212"),
        ...
        related.length > 0 && (React.createElement("div", { style: { marginTop: 64 } },
            ...
            React.createElement("div", { className: "product-grid" }, related.map((p) => React.createElement(ProductCard, { key: p.slug, product: p, fragrance: data.fragrances.find((f) => f.slug === p.fragranceSlug), nav: nav })))))));
}
...
function AboutPage() {
    return (React.createElement("div", { className: "container", style: { padding: "48px 20px 80px", maxWidth: 760 } },
        ...
        React.createElement("div", { style: { marginTop: 64 } },
            ...
            React.createElement("div", { className: "why-grid", style: { marginTop: 32 } }, [
            ...
            ].map(([t, d]) => (React.createElement("div", { key: t, className: "hairline-top" },
                React.createElement("h4", { style: { ...serif, fontSize: 16, color: C.ink, fontWeight: 500, marginBottom: 8 } }, t),
                React.createElement("p", { style: { ...sans, fontSize: 13.5, color: C.ink70, lineHeight: 1.6 } }, d)))))),
        React.createElement("div", { style: { marginTop: 64 } },
